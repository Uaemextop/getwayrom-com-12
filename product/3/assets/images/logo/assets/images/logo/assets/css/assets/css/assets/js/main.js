...
<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon" href="https://getwayrom.com/assets/images/logo/primal_favicon.png" />
...
<link rel="stylesheet" href="https://getwayrom.com/assets/css/vendor/plugins.min.css">
<link rel="stylesheet" href="https://getwayrom.com/assets/css/style.min.css">
<link rel="stylesheet" href="https://getwayrom.com/assets/css/responsive.min.css">
...
.size_blk .radio label:after {
    content: '';
    display: table;
    clear: both;
}
.size_blk .radio label:before{
    display:none;
}
.size_blk .radio label input[type="radio"] {
    display: none;
}
.size_blk .radio label input[type="radio"]:checked + .cr > .cr-icon {
    transform: scale(1) rotateZ(0deg);
    opacity: 1;
}
.size_blk .radio label input + .shor_checkbox{
    background: #b4c9ff;   
    border-radius: 8px;    
    padding: 5px 15px;
    font-size: 16px;
...
.size_blk .radio label input[type="radio"]:checked + .shor_checkbox{
    background:#3362dc;
    color:#fff;
}
.img-block {
...
<div class="preloader">
    ...
    <span></span>
        ...
        <!--====== PRELOADER PART ENDS ======-->
        <div id="main" class="product_dtl_main">
    ...
    <div class="search_container">
      ...
      setTimeout(() => {
          try {
            ...
            <section class="breadcrumb-area" style="padding: 15px 0 0px;text-align: left;background: transparent;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="breadcrumb-content" style="padding: 0 5px;">
            ...
            <section class="product-details-area mtb-60px" style="margin-top:20px;">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="product-details-img product-details-tab">
                                ...
                                <div class="slider-main2 zoompro-22">
								
								    								<div class="zoompro-border22 zoompro-span22">
    								    <a href="https://getwayrom.com/upload/products/714161file.png" data-lightbox="photos">
                                        <img src="https://getwayrom.com/upload/products/714161file.png" class="img-fluid zoompro22" alt="" />
                                        </a>
                                    </div>
                                ...
                                <div class="product-dec-slider-2 slider-nav2" style="margin-top: 15px;">
                                    
								    								<div>
    								    <img class="img-fluid" src="https://getwayrom.com/upload/products/714161file.png" style="cursor:pointer;" alt="" />
    								</div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                             <form name="form1" action="" id="cart_form" method="post">
                            <div class="product-details-content">
                                <h2>OPPO</h2>
                                <p class="reference">Category:<span> </span></p>
                                <div class="pro-details-rating-wrap">
                                    ...
                                    <!--<span class="read-review"><a class="reviews" href="#">Read reviews (0)</a></span>-->
                                </div>
                                
                                                                <div class="pricing-meta">
                                    <!--<ul>
                                        <li class="old-price">₹0</li>
                                        <li class="current-price" style="font-size:30px; font-weight:bold;">₹2000</li>
                                        <li class="discount-price">Save ₹-2000</li>
                                    </u>-->
									<div class="dtl_price_area">
									<span class="current_price">
									    <i class="fa fa-inr" aria-hidden="true"></i> 2,000									</span>
									
									<!--<span class="old_price" style="text-decoration:line-through;">
									    <i class="fa fa-inr" aria-hidden="true"></i> 0									</span>-->
									
									<!--<span style="background-color: #5cb85c; padding:0 5px; color:white; border-radius:5px;">% off</span>
									<p class="discount_price">
									You are saving <i class="fa fa-inr" aria-hidden="true"></i> -2,000									</p>-->
                                ...
                                <div class="description" style="padding:15px 0;">
                                    ...
                                    <div class="pro-details-quality mt-0px" style="margin-bottom:15px;">
                                        <!--<div class="cart-plus-minus">
                                            <input class="cart-plus-minus-box" type="text" name="qtybutton" value="1" />
                                            <input type="hidden" name="proid" value="3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" />
                                        </div>-->
                                        ...
                                        <div class="pro-details-cart btn-hover">
                                            ...
                                            <input type="hidden" name="proid" value="3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" />
                                                <input type="hidden" name="sale_price" value="2000" />
                                            <button id="add_to_cart" type="submit" name="addtocart"> + Add To Cart</button>
                                        </div>
										<!--<div class="pro_details_buy_now_btn btn-hover">
                                            <a href="https://getwayrom.com/checkout.php?proid=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js&qty=1" class="buy_now_btn"> Buy Now</a>
                                        </div>-->
                                        
										<!--<div class="pro-details-wish-com" style="border:none;">
											<div class="pro-details-whatsapp" style="border:none;">
												<a href="https://api.whatsapp.com/send?phone=918511400395&text=*I%20want%20to%20Buy*%20OPPO%20https://www.buyprimal.in/product.php?id=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" target="_blank" style="font-size:40px; color:green; border:none;"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
											</div>
											<div class="pro-details-wishlist">
												<a href="wishlist.php?proid=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js&qty=1"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
											</div>									
										</div>-->
                                ...
                                <!--<div class="pro-details-wish-com">
                                    <div class="pro-details-wishlist">
                                        <a href="wishlist.php?proid=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js&qty=1"><i class="ion-android-favorite-outline"></i>Add to wishlist</a>
                                    </div>
								...
								<div class="pro_details_buy_link_area">
								<div style="padding-bottom:15px;"><b><h4 style="font-size:14px; font-weight:bold;">ALSO AVAILABLE AT</h4></b></div>
																								    
								    <a href="https://api.whatsapp.com/send?phone=919420630774&text=*I%20want%20to%20Buy*%20OPPO%20https://www.getwayrom.com/product.php?id=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" class="whatsapp_link" target="_blank">
    								    <img src="https://getwayrom.com/assets/images/whatsapp_btn.png" alt="" class="img-fluid"/>
    								</a>
								</div>
                                    ...
                                    <div class="social-info">
                                        <ul>
                                            <li><a href="https://www.facebook.com/sharer.php?u=http://getwayrom.com/product.php?id=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" target="_blank"><i class="ion-social-facebook"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/intent/tweet?text=OPPO&url=http://getwayrom.com/product.php?id=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" target="_blank"><i class="ion-social-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://plus.google.com/share?url=http://getwayrom.com/product.php?id=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" target="_blank"><i class="ion-social-google"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://www.instagram.com/?url=http://getwayrom.com/product.php?id=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" target="_blank"><i class="ion-social-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://api.whatsapp.com/send?phone=919420630774&text=Interested%20to%20Buy%20https://www.getwayrom.com/product.php?id=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js" target="_blank"><i class="ion-social-whatsapp"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <!--<div class="pro-details-policy">
                                    <ul>
                                        <li><img src="assets/images/icons/policy.png" alt="" /><span>Free Delivery </span></li>
                                        <li><img src="assets/images/icons/policy-2.png" alt="" /><span>Easy Return </span></li>
                                        <li><img src="assets/images/icons/policy-3.png" alt="" /><span>Secure Checkout </span></li>
                                    </ul>
                                </div>-->
			...
			<!-- Static Area Start -->
            <section class="static-area" style="padding: 0px 0 40px;">
                <div class="container">
                    <div class="static-area-wrap">
                        <div class="row">
                            <!-- Static Single Item Start -->
                             <div class="col-lg-3 col-xs-6 col-md-6 col-sm-6 col-6 single_static_blk">
                                <div class="single-static pb-res-md-0 pb-res-sm-0 pb-res-xs-0">
                                    <img src="https://getwayrom.com/assets/images/icons/static-icons-1.png" alt="" class="img-responsive" />
                                    <div class="single-static-meta">
                                        <h4>FREE DELIVERY</h4>
                                        <p>For all orders over <i class="fa fa-inr" aria-hidden="true"></i>499</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Static Single Item Start -->
                             <div class="col-lg-3 col-xs-6 col-md-6 col-sm-6 col-6 single_static_blk">
                                <div class="single-static pb-res-md-0 pb-res-sm-0 pb-res-xs-0 pt-res-xs-20">
                                    <img src="https://getwayrom.com/assets/images/icons/static-icons-2.png" alt="" class="img-responsive" />
                                    <div class="single-static-meta">
                                        <h4>3 DAYS RETURN</h4>
                            ...
                            <!-- Static Single Item Start -->
                             <div class="col-lg-3 col-xs-6 col-md-6 col-sm-6 col-6 single_static_blk">
                                <div class="single-static pt-res-md-30 pb-res-sm-30 pb-res-xs-0 pt-res-xs-20">
                                    <img src="https://getwayrom.com/assets/images/icons/static-icons-3.png" alt="" class="img-responsive" />
                                    <div class="single-static-meta">
                            ...
                            <!-- Static Single Item Start -->
                             <div class="col-lg-3 col-xs-6 col-md-6 col-sm-6 col-6 single_static_blk">
                                <div class="single-static pt-res-md-30 pb-res-sm-30 pt-res-xs-20">
                                    <img src="https://getwayrom.com/assets/images/icons/static-icons-4.png" alt="" class="img-responsive" />
                                    <div class="single-static-meta">
                                        <h4>FAST DELIVERY</h4>
            ...
            <section class="recent-add-area" style="display:none;">
                <div class="container">
					...
					<div class="product_item_slider owl-carousel owl-nav-style">
                                                ...
                                                <div class="product_blkitem" onClick="window.location='https://getwayrom.com/product/2/Tool-rent'">
                            <div class="product_blkiteminner">
                                <div class="product_blkitem_thumb">
                                    <a href="https://getwayrom.com/product/2/Tool-rent">
                                        <img src="https://getwayrom.com/upload/products/147409unlock.avif" alt="" />
                                    </a>
                                </div>
								<div class="listing_wishlist">
									<a href="" class="listing_wishlist_link"><i class="ion-android-favorite-outline"></i></a>
								</div>
                                <div class="product_blkitem_content">
									 <div class="product_blkitem_price">
									 <span class="new_price"><b><i class="fa fa-inr" aria-hidden="true"></i> 80</b></span>
									 <span class="old_price"><i class="fa fa-inr" aria-hidden="true"></i> 0</span>
									 <span style="background-color: #5cb85c; padding:0 5px; color:white; border-radius:5px;">% off</span>
									 </div>
                                    <div class="product_blkitem_name">
                                        <h4><b><a href="https://getwayrom.com/product/2/Tool-rent">Tool rent</a></b></h4>
                                    </div>
                                     <div class="buy_now_btn_area">
                                        <a href="https://getwayrom.com/product/2/Tool-rent" class="buy_now_btn">Buy Now</a>
                                      </div>
                                 </div>
                                 
								<!--<div class="view_add_to_cart_area">
								<div class="view_add_to_cart_areainner">
									<ul>
									<li><a href="product.php?id=2" class="add_to_cart_btn">Add to Cart</a></li>
									</ul>
								</div>
								</div>-->
						                        ...
						                        <div class="product_blkitem" onClick="window.location='https://getwayrom.com/product/1/test'">
                            <div class="product_blkiteminner">
                                <div class="product_blkitem_thumb">
                                    <a href="https://getwayrom.com/product/1/test">
                                        <img src="https://getwayrom.com/upload/products/683360Screenshot 2025-07-05 045445.png" alt="" />
                                    </a>
                                </div>
								<div class="listing_wishlist">
									<a href="" class="listing_wishlist_link"><i class="ion-android-favorite-outline"></i></a>
                                ...
                                <div class="product_blkitem_content">
									 <div class="product_blkitem_price">
									 <span class="new_price"><b><i class="fa fa-inr" aria-hidden="true"></i> 100</b></span>
									 <span class="old_price"><i class="fa fa-inr" aria-hidden="true"></i> 5000</span>
									 <span style="background-color: #5cb85c; padding:0 5px; color:white; border-radius:5px;">% off</span>
									 </div>
                                    <div class="product_blkitem_name">
                                        <h4><b><a href="https://getwayrom.com/product/1/test">test</a></b></h4>
                                    </div>
                                     <div class="buy_now_btn_area">
                                        <a href="https://getwayrom.com/product/1/test" class="buy_now_btn">Buy Now</a>
                                      </div>
                                 </div>
								...
								<div class="view_add_to_cart_areainner">
									<ul>
									<li><a href="product.php?id=1" class="add_to_cart_btn">Add to Cart</a></li>
									</ul>
								</div>
								</div>-->
                    ...
                    <div class="description-review-wrapper">
                        ...
                        <div class="tab-content description-review-bottom">
                            ...
                            <div id="des-details1" class="tab-pane active">
                                <div class="product-description-wrapper" style="text-align:justify;">
                                    Checking Tested Network & light Mic Speaker                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="review-wrapper">
                                                ...
                                                <div class="review-img">
                                                    <img src="https://getwayrom.com/assets/images/testimonial-image/1.png" alt="" />
                                                </div>
                                                <div class="review-content">
                                                    <div class="review-top-wrap">
                                                        <div class="review-left">
                                                            <div class="review-name">
                                                                <h4><b>Milan Patel</b></h4>
                                                            </div>
                                                            <div class="rating-product">
                                                                <i class="ion-android-star"></i>
                                                                <i class="ion-android-star"></i>
                                                    ...
                                                    <div class="review-bottom">
                                                        <p><b>Best post work out supplement for healthy recovery.</b></p>
                                                        <p>As a fitness freak, I always use to see improvement in my workout regime and health. After the hefty workout, I felt tired so I was in search of a supplement that gives me energy and gives me healthy recovery. This supplement works as a catalyser. Their content fights against free radicals, the main culprit against our healthy recovery.</p>
                                                    </div>
                                                </div>
                                            </div>
                                                                                        <div class="single-review">
                                                ...
                                                <div class="review-content">
                                                    ...
                                                    <div class="review-bottom">
                                                        <p><b>MY FAMILY IMMUNITY PROTECTOR</b></p>
                                                        <p>It will be good to take preventive measures which boost our immunity in these times. I have ordered these tablets for my family and they are using it for over 2 months. It's worked well for all of us. Moreover I am using it as my post workout recovery. Because it’s content protect our cell those are damaged due to heavy workout.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="ratting-form">
                                                <form action="">
                                                    <div class="star-box">
                                                        ...
                                                        <div class="rating-product">
                                                            <input type="checkbox" class="checkbox" id="st1" value="1" />
                                                            <label for="st1"></label>
                                                            <input type="checkbox" class="checkbox" id="st2" value="2" />
                                                            <label for="st2"></label>
                                                            <input type="checkbox" class="checkbox" id="st3" value="3" />
                                                            <label for="st3"></label>
                                                            <input type="checkbox" class="checkbox" id="st4" value="4" />
                                                            <label for="st4"></label>
                                                            <input type="checkbox" class="checkbox" id="st5" value="5" />
                                                            <label for="st5"></label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="rating-form-style form-submit">
                                                                ...
                                                                <input type="submit" name="Post_review" value="Submit" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
            ...
            <section class="recent-add-area mt-30 mb-30px">
                <div class="container">
					...
					<div class="product_item_slider owl-carousel owl-nav-style">
                                                ...
                                                <div class="product_blkitem">
                            <div class="product_blkiteminner">
                                <div class="product_blkitem_thumb">
                                    <a href="https://getwayrom.com/product/3/OPPO">
                                        <img src="https://getwayrom.com/upload/products/714161file.png" alt="" />
                                    </a>
                                </div>
								<div class="listing_wishlist">
									<a href="" class="listing_wishlist_link"><i class="ion-android-favorite-outline"></i></a>
                                ...
                                <div class="product_blkitem_content">
                                    <div class="product_blkitem_name">
                                        <h4><a href="https://getwayrom.com/product/3/OPPO">OPPO</a></h4>
                                        <div class="jet_woo_product_blk_content_des" style=""><h4 style="text-transform: capitalize; font-size:13px;"></h4></div>
                                    </div>
									 <div class="product_blkitem_price">
									 <span class="new_price"><b><i class="fa fa-inr" aria-hidden="true"></i> 2,000</b></span>
									 <span class="old_price"><i class="fa fa-inr" aria-hidden="true"></i> 0</span>
									 <span style="background-color: #5cb85c; padding:0 5px; color:white; border-radius:5px;">% off</span>
									 </div>
                                    
                                     <div class="buy_now_btn_area">
                                        <a href="https://getwayrom.com/product/3/OPPO" class="buy_now_btn">Buy Now</a>
                                      </div>
                                 </div>
								...
								<div class="view_add_to_cart_areainner">
									<ul>
									<li><a href="product.php?id=3" class="add_to_cart_btn">Add to Cart</a></li>
									</ul>
								</div>
								</div>-->
                            </div>
                            ...
                            <div class="product_blkiteminner">
                                ...
                                <div class="product_blkitem_content">
                                    <div class="product_blkitem_name">
                                        <h4><a href="https://getwayrom.com/product/2/Tool-rent">Tool rent</a></h4>
                                        <div class="jet_woo_product_blk_content_des" style=""><h4 style="text-transform: capitalize; font-size:13px;"></h4></div>
                                    </div>
									 <div class="product_blkitem_price">
									 <span class="new_price"><b><i class="fa fa-inr" aria-hidden="true"></i> 80</b></span>
                            ...
                            <div class="product_blkiteminner">
                                ...
                                <div class="product_blkitem_content">
                                    <div class="product_blkitem_name">
                                        <h4><a href="https://getwayrom.com/product/1/test">test</a></h4>
                                        <div class="jet_woo_product_blk_content_des" style=""><h4 style="text-transform: capitalize; font-size:13px;"></h4></div>
                                    </div>
									 <div class="product_blkitem_price">
									 <span class="new_price"><b><i class="fa fa-inr" aria-hidden="true"></i> 100</b></span>
                ...
                <div class="recent-product-slider owl-carousel owl-nav-style" style="display:none;">
                    
                                <article class="list-product">
                    <div class="img-block">
                        <a href="https://getwayrom.com/product/3/OPPO" class="thumbnail">
                            <img class="first-img" src="https://getwayrom.com/upload/products/714161file.png" alt="" />
                            <!--<img class="second-img" src="assets/images/product-image/organic/product-12.jpg" alt="" />-->
                        </a>
                        <div class="quick-view">
                            <a class="quick_view" href="https://getwayrom.com/product/3/OPPO">
                                <i class="ion-ios-search-strong"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <ul class="product-flag">
                        <li class="new">New</li>
                    </ul>                    <div class="product-decs" onClick="window.location='product.php?id='">
                        <a class="inner-link" href="#"><span>Mothobord</span></a>
                        <h2><a href="https://getwayrom.com/product/3/OPPO" class="product-link">OPPO</a></h2>
                        <div class="pricing-meta">
                            <ul>
                                <li class="old-price">₹0</li>
                                <li class="current-price">₹2,000</li>
                                <!--<li class="discount-price">Save 0</li>-->
                            </ul>
                        </div>
                    </div>
                    <div class="add-to-link">
                        <ul>
							                                <li class="cart"><a class="https://getwayrom.com/cart-btn" href="https://getwayrom.com/cart.php?proid=3&qty=1">ADD TO CART </a></li>
                                                                                        <li><a href="https://getwayrom.com/wishlist.php?proid=3&qty=1"><i class="ion-android-favorite-outline"></i></a></li>
                        </ul>
                    </div>
                </article>
            ...
            <p>&nbsp;</p><p>&nbsp;</p>
                	...
                	<ul>
                		<li><a href="https://getwayrom.com/cart.php?proid=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js&qty=1" class="add_cart_btn">Add To Cart</a></li>
                		<li><a href="https://getwayrom.com/checkout.php?proid=3/assets/images/logo/assets/images/logo/assets/css/assets/css/assets/js&qty=1" class="buy_now_btn">Buy Now</a></li>
                	</ul>
                </div>
...
<!--====== Vendors js ======-->
<script src="https://getwayrom.com/assets/js/vendor/jquery-3.5.1.min.js"></script>
<script src="https://getwayrom.com/assets/js/vendor/modernizr-3.7.1.min.js"></script>
...
<!--====== Use the minified version files listed below for better performance and remove the files listed above ======-->
<script src="https://getwayrom.com/assets/js/plugins.min.js"></script>

<!-- Main Activation JS -->
<script src="https://getwayrom.com/assets/js/main2.js"></script>
...
$(document).ready(function() {
 ...
 $(document).on('click','#add_to_cart', function(){
        ...
        if(auth == ''){
            ...
            window.location = '/login.php?ret=error';
            return;
        }
        ...
        $.ajax({
            type:'post',
            url:'https://getwayrom.com/cart_ajax.php',
            data:formData,
            success:function(response) {

              totalCartItems();
              $(".right_sideber_overlay ").addClass('open');
              $(".right_sideber_cart").addClass('open');
                 Swal.fire({
                    icon: 'success',
