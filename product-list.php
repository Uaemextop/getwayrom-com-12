...
<html lang="en">
   <head>
      ...
      <style>
         ...
         .show_more_btn_area .show_more_btn{
         padding: 8px 35px;
...
<body>
    <div class="search_container">
      ...
      setTimeout(() => {
                        ...
                        <div class="breadcrumb-content">
                            <ul class="breadcrumb-links">
                                <li><a href="index.php">Home</a></li>
                                                                <li><a href="shop.php?cat=1">Mothobord</a></li>
                                                                                                <li>test</li>
                                                            </ul>
                        </div>
                    </div>
         ...
         <!-- Breadcrumb Area End -->
         <div class="shop-category-area" style="margin-top:30px; padding-bottom:30px;">
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-12 col-12">
                     <div class="left-sidebar">
                        ...
                        <div class="left_sidebarinner">
                           <!-- Sidebar single item -->									
                           <div class="sidebar-widget">
                              <h4 class="pro-sidebar-title">SEARCH</h4>
                              <div class="sidebar_widget_search_area sidebar_widget_content">
                                 <div class="sidebar_widget_search_areainner">
                                    <div class="search-widget">
                                       <form action="product-list.php" method="post" name="form1">
                                          <input type="hidden" name="cat" value="1">
                                          <input type="hidden" name="subcat" value="9">
                                          <input name="keyword" placeholder="Search entire store here ..." value="" type="text">
                                          <button type="submit" name="enter"><i class="ion-ios-search-strong"></i></button>
                                       </form>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="sidebar-widget mt-20">
                              ...
                              <div class="sidebar_widget_category_area sidebar_widget_content">
                                 <div class="sidebar_widget_category_areainner">
                                    <ul>
                                                                              <li>
                                          <a href="shop.php?cat=1">Mothobord</a>
                                                                                    <ul>
                                                                                          <li><a href="product-list.php?cat=1&subcat=9"><span>test </span></a></li>
                                                                                       </ul>
                                       </li>
                                                                              <li>
                                          <a href="shop.php?cat=2">Mobile Accesories</a>
                                                                                    <ul>
                                                                                       </ul>
                                       </li>
                                                                              <li>
                                          <a href="shop.php?cat=13">Tool Rent</a>
                                                                                    <ul>
                                                                                       </ul>
                                       </li>
                                                                           </ul>
                           ...
                           <div class="sidebar-widget mt-20">
                              ...
                              <div class="sidebar_widget_price_list_area sidebar_widget_content">
                                 <div class="sidebar_widget_price_list_areainner">
                                    <ul>
                                                                              <li><a href="product-list.php?cat=1&subcat=9&min=0&max=500">Under <i class="fa fa-inr" aria-hidden="true"></i> 500</a></li>
                                       <li><a href="product-list.php?cat=1&subcat=9&min=500&max=1000"><i class="fa fa-inr" aria-hidden="true"></i> 500 - <i class="fa fa-inr" aria-hidden="true"></i> 1,000</a></li>
                                       <li><a href="product-list.php?cat=1&subcat=9&min=1000&max=1500"><i class="fa fa-inr" aria-hidden="true"></i> 1,000 - <i class="fa fa-inr" aria-hidden="true"></i> 1,500</a></li>
                                       <li><a href="product-list.php?cat=1&subcat=9&min=1500&max=3000"><i class="fa fa-inr" aria-hidden="true"></i> 1,500 - <i class="fa fa-inr" aria-hidden="true"></i> 3,000</a></li>
                                       <li><a href="product-list.php?cat=1&subcat=9&min=3000&max=10000">Over <i class="fa fa-inr" aria-hidden="true"></i> 3,000</a></li>
                                    </ul>
                                 </div>
                                 <div class="sidebar_widget_price_range_area">
                                    <form action="product-list.php" method="post" name="form2">
                                       <input type="hidden" name="cat" value="1">
                                       <input type="hidden" name="subcat" value="9">
                                                                              <div class="sidebar_widget_price_range_areainner">
                                          <div class="min_price_range">
                                             <span class="icon"><i class="fa fa-inr" aria-hidden="true"></i></span>
                                             <input type="text" name="min" class="form-control price_range_input" value="" placeholder="Min">
                                          </div>
                                          <div class="max_price_range">
                                             <span class="icon"><i class="fa fa-inr" aria-hidden="true"></i></span>
                                             <input type="text" name="max" class="form-control price_range_input" value="" placeholder="Max">
                                          </div>
                                          <div class="btn_price_range">
                                             <button type="submit" class="btn_price" name="gosearch">Go</button>
                                          </div>
                                       </div>
                                    </form>
                                 </div>
                           ...
                           <!-- Sidebar single item -->
                           <div class="sidebar-widget mt-20">
                              <h4 class="pro-sidebar-title">DISCOUNT</h4>
                              <div class="sidebar_widget_discount_list_area sidebar_widget_content">
                                 <div class="sidebar_widget_discount_list_areainner">
                                    <ul>
                                                                              <li><a href="product-list.php?cat=1&subcat=9&discount=10">10% Off or more</a></li>
                                       <li><a href="product-list.php?cat=1&subcat=9&discount=25">25% Off or more</a></li>
                                       <li><a href="product-list.php?cat=1&subcat=9&discount=35">35% Off or more</a></li>
                                       <li><a href="product-list.php?cat=1&subcat=9&discount=50">50% Off or more</a></li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
    ...
    <h2 style="margin-bottom:20px;">test</h2><b>There Are 1 Products.</b>    
    <div class="shop-bottom-area mt-35">
        <div class="tab-content jump">
            <div id="shop-1" class="tab-pane active">
                <div class="row">                            <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6 col-xs-6 mb-30px product_blkitem" style="display:block;">
                                <div class="product-slider-item">
                                    <article class="list-product mb-30px">
                                        <div class="img-block">
                                            <a href="https://getwayrom.com/product-details.php?id=3" class="thumbnail">
                                                <img class="first-img" src="upload/products/714161file.png" alt="" style="height:300px; width:100%; object-fit:cover;" />
                                                <img class="second-img" src="upload/products/714161file.png" alt="" style="height:300px; width:100%; object-fit:cover;" />
                                            </a>
                                            <div class="quick-view">
                                                <a class="quick_view" href="https://getwayrom.com/product-details.php?id=3" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal">
                                                    <i class="ion-ios-search-strong"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-decs">
                                            <a class="inner-link" href="https://getwayrom.com/product-details.php?id=3">
                                                <span>Mothobord</span>
                                            </a>
                                            <h2><a href="https://getwayrom.com/product-details.php?id=3" class="product-link">OPPO</a></h2>
                                            <div class="pricing-meta">
                                                <ul>
                                                    <li class="current-price"><i class="fa fa-inr"></i> 2,000</li>
                                                                                                    </ul>
                                            </div>
                                        </div>
                                        <div class="add-to-link">
                                            <ul>
                                                <li class="cart">
                                                    <a class="cart-btn" href="https://getwayrom.com/product-details.php?id=3">VIEW DETAILS</a>
                                                </li>
                                                <li>
                                                    <a href="wishlist.php?id=3"><i class="ion-android-favorite-outline"></i></a>
                                                </li>
                                                <li>
                                                    <a href="compare.php?id=3"><i class="ion-ios-shuffle-strong"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </article>
...
<link rel="preload" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">      </div>
      ...
      <script>
         $(document).ready(function(){
           $(".product_blkitem").slice(0, 12).show();
           $("#loadMore").on("click", function(e){
             e.preventDefault();
             $(".product_blkitem:hidden").slice(0, 12).slideDown();
             if($(".product_blkitem:hidden").length == 0) {
