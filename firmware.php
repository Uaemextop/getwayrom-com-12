...
<head>
    ...
    <title>Firmware Downloads | Getwayrom</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="breadcrumb_content">
                    <ul class="breadcrumb">
                        <li><a href="index.php">Home</a></li>
                                                    <li><a href="firmware.php?cat=53">ALCATEL</a></li>
                                                                                                                    </ul>
                </div>
            </div>
        </div>
            ...
            <section class="categorie_section" style="padding:10px 0 0;">
        <div class="container">
            <div class="categorie_sectioninner">
                <div class="download_fld_sec_top" onClick="window.location='firmware.php'" style="margin-bottom:10px;">
                    <div class="icon_area">
                        <a href="#">
                ...
                <div class="categorie_sec_row">
                        ...
                        <a href="firmware.php?cat=53&sub=1545">
                            <div class="categorie_sec_blkinner position-relative">
                                                                <div class="icon"><img src="assets/images/icons/folder.png" width="100" height="76"
                                        class="img-fluid"></div>
                                <div class="txt">
                                    ALCATEL AUTH                                                                    </div>
                            </div>
                                        ...
                                        <div class="categorie_sec_column categorie_sec_blk">
                        <a href="firmware.php?cat=53&sub=602">
                            <div class="categorie_sec_blkinner position-relative">
                                                                <div class="icon"><img src="assets/images/icons/folder.png" width="100" height="76"
                                        class="img-fluid"></div>
                                <div class="txt">
                                    ALCATEL Firmware                                                                        <p style="font-size:14px; font-weight:bold;">
                                        Download Firmware ALCATEL                                    </p>
                                                                    </div>
                            </div>
                        </a>
                    </div>
                                        <div class="categorie_sec_column categorie_sec_blk">
                        <a href="firmware.php?cat=53&sub=603">
                            <div class="categorie_sec_blkinner position-relative">
                                                                <div class="icon"><img src="assets/images/icons/folder.png" width="100" height="76"
                                        class="img-fluid"></div>
                                <div class="txt">
                                    ALCATEL NVRAM                                                                        <p style="font-size:14px; font-weight:bold;">
                                        DOWNLOAD FILES ALCATEL NVRAM                                    </p>
                                                                    </div>
                            </div>
                        </a>
                    </div>
                                        <div class="categorie_sec_column categorie_sec_blk">
                        <a href="firmware.php?cat=53&sub=604">
                            <div class="categorie_sec_blkinner position-relative">
                                                                <div class="icon"><img src="assets/images/icons/folder.png" width="100" height="76"
                                        class="img-fluid"></div>
                                <div class="txt">
                                    ALCATEL TOOLS                                                                        <p style="font-size:14px; font-weight:bold;">
                                        Firmware ALCATEL TOOLS                                    </p>
                                                                    </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="container">
                                <div>
                    <h5 style="margin:25px 0 10px 0; color:#000;">Available Firmwares</h5>
                </div>
                <div class="row" sty="margin:0 -5px;">
                                        <div class="col-md-12 col-sm-12 col-12" style="padding:0 10px;margin-bottom:10px;">
                        <div class="relative_box"
                            style="display:flex;border: 1px solid #ddd; padding: 10px;  border-radius: 10px;">
                            <!--<div class="newProTag"><span class="icon"><i class="fa fa-star-o"></i></span></div>-->
                            <div style="width:10%; height:150px; float:left;" class="position-relative">
                                <img src="upload/file_thumbnail.gif" alt="" class="img-fluid"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=28458"
                                            style="color: #000000;"><b>
                                                GSM RK TOOL 1.1.rar                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                    <img src="https://gsm-firmware.com/templates/default-downloads/html/en/assets/images/star-off.png"
                                        alt="" />&nbsp;
                                    <img src="https://gsm-firmware.com/templates/default-downloads/html/en/assets/images/star-off.png"
                                        alt="" />&nbsp;
                                    <img src="https://gsm-firmware.com/templates/default-downloads/html/en/assets/images/star-off.png"
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        80                                    </span> | Size: <span style="color: #FF0000;">
                                        10 MB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    GSM RK TOOL 1.1.rar                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=28458" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=28272"
                                            style="color: #000000;"><b>
                                                Demo switch 150220253.apk                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        40                                    </span> | Size: <span style="color: #FF0000;">
                                        4 MB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Demo switch 150220253.apk                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=28272" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=28242"
                                            style="color: #000000;"><b>
                                                Samsung Galaxy Tab A9 (WiFi) SM-X110 INS X110XXS7DYL2 BIT-7 B(Android 16) Scatter Firmware File Convert to Normal and Dead Boot Reapir File BY www.GsmSrinuTools.com                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        350                                    </span> | Size: <span style="color: #FF0000;">
                                        5.61 GB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Samsung Galaxy Tab A9 (WiFi) SM-X110 INS X110XXS7DYL2 BIT-7 B(Android 16) Scatter Firmware File Conv                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=28242" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=27644"
                                            style="color: #000000;"><b>
                                                All Samsung Devices Android 16 One Click Reset Frp (Free Tool).rar                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    All Samsung Devices Android 16 One Click Reset Frp (Free Tool).rar                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=27644" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=27276"
                                            style="color: #000000;"><b>
                                                Samsung Galaxy Tab A9 (WiFi) SM-X110 INS X110XXS6CYI3 BIT-6 V(Android 15) Convert to Normal and Dead Boot Reapir File                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        600                                    </span> | Size: <span style="color: #FF0000;">
                                        8.97 GB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    DEAD BOOT RIPER & HANG LOGO ALL EROORS FIX THIS FILE                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=27276" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=26449"
                                            style="color: #000000;"><b>
                                                Samsung Galaxy Tab A9 (WiFi) SM-X110 INS X110XXS5CYG1 BIT-5 U5(Android 15) FULL DUMP FILE BY PANDORA TOOL TESTED                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        150                                    </span> | Size: <span style="color: #FF0000;">
                                        5.94 GB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Samsung Galaxy Tab A9 (WiFi) SM-X110 INS X110XXS5CYG1 BIT-5 U5(Android 15) FULL DUMP FILE BY PANDORA                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=26449" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=26207"
                                            style="color: #000000;"><b>
                                                Xiaomi Redmi Note 13 5G / 13R Pro V5 WITHOUT AUTH (XIAOMI-V5-SPFT                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        700                                    </span> | Size: <span style="color: #FF0000;">
                                        61.44 MB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Redmi Note 13 5G / 13R Pro V5 WITHOUT AUTH                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=26207" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=26101"
                                            style="color: #000000;"><b>
                                                Samsung Tab A9 (WiFi) SM-X110 X110XXS5CYG1 BIT-U5 & S5(Android 15) DEAD BOOT RIPER AND GOVT TO NORMAL File By www.GetwayROM.com                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        300                                    </span> | Size: <span style="color: #FF0000;">
                                        4.24 GB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    othor website Price 25.00 USD please do other                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=26101" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=25965"
                                            style="color: #000000;"><b>
                                                RMX3943export_11_15.0.0.520EX01_2025033017270000 Project ID= 24723                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Realme 14x 5G Project ID= 24723                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=25965" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=25271"
                                            style="color: #000000;"><b>
                                                Motorola Moto G85 5G (malmo) EDL Point Test Point File Pass (Strong&321).rar                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        100                                    </span> | Size: <span style="color: #FF0000;">
                                        5.0 MB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Motorola Moto G85 5G (malmo) EDL Point Test Point File Pass (Strong&321).rar                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=25271" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=24936"
                                            style="color: #000000;"><b>
                                                Motorola Moto G35 5G PAC Firmware [Dead Boot Repair] [manila_UOA34.216-174_1539cd] Security Patch 10-02-2025 [Fix Rom] Tested 100% Working Without Paid Tool                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Motorola Moto G35 5G PAC Firmware [Dead Boot Repair] [manila_UOA34.216-174_1539cd] Security Patch 10                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=24936" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=24807"
                                            style="color: #000000;"><b>
                                                Auth_MDM_Unlock_Tool_Gsm R.K.rar                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Auth_MDM_Unlock_Tool_Gsm R.K.rar                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=24807" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=21426"
                                            style="color: #000000;"><b>
                                                Redmi_Poco_C51_Convert_Airtel_To_Normal_100%Tested_Firmware                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Redmi_Poco_C51_Convert_Airtel_To_Normal_100%Tested_Firmware                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=21426" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=19424"
                                            style="color: #000000;"><b>
                                                Any IDM expire This Only Run 100% Activate Tested Life Time Getwayrom.com.rar                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        99                                    </span> | Size: <span style="color: #FF0000;">
                                        5 MB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    This Support Windows 7 8 10 11                                 </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=19424" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        ...
                        <div class="relative_box"
                            ...
                            <div style="width:80%; float:left;">
                                <div class="txt" style="color: #000000;">
                                    <h5><a href="firmwares.php?firm=22040"
                                            style="color: #000000;"><b>
                                                Internet Download Manager registration Complate No Yearly Charge.rar                                            </b></a></h5>
                                </div>
                                <div style="color: #000000;">
                                                                                                        </div>
                                <div style="color: #000000;">
                                ...
                                <div class="txt" style="color: #000000; font-weight: 700;">
                                    Price: <span style="color: #FF0000; letter-spacing: 1px;">₹
                                        199                                    </span> | Size: <span style="color: #FF0000;">
                                        15 MB                                    </span>
                                </div>

                                <div class="txt" style="color: #000000; font-weight: 700; letter-spacing: .5px;">Model:
                                    Internet Download Manager registration Complate No Yearly Charge.rar                                </div>
                            </div>

                            <div style="width:10%; float:left; position: relative;">
                                <a class="btn btn-dark content-btn"
                                    href="firmwares.php?firm=22040" style="background-color: #000000; border-color: #1D970D; color: #FFF; 
                                            position: absolute; bottom: 0; right: 0;">
                                    <i class="fa fa-download fw-r5"></i> Download
                                </a>
                            </div>
        ...
        <section class="our_product_section" style="display:none;">
            <div class="container">
                <div class="our_product_sectioninner">
                    <div class="row">
                        <div
                            class="col-xs-3 col-lg-3 col-md-3 col-sm-4 col-12 our_product_sec_block our_product_display_flex_box">
                        ...
                        <div class="col-xs-3 col-lg-3 col-md-3 col-sm-4 col-12 our_product_sec_block">
                            <div class="our_product_sec_blockinner">
                                ...
                                <div class="listing_wishlist">
                                    <a href="" class="listing_wishlist_link"><i
                                    ...
                                    <article class="list-product">
                                        <div class="img-block">
                                            ...
                                            <a href="product.php?id=3" class="thumbnail">
                                                <img class="first-img"
                                                    src="wap/upload/products/714161file.png"
                                                    alt="" />
                                        ...
                                        <ul class="product-flag">
                                            ...
                                            <a class="inner-link" href="#"><span>
                                                    Mothobord                                                </span></a>
                                            <h2><a href="product.php?id=3"
                                                    class="product-link">
                                                    OPPO                                                </a></h2>
                                        ...
                                        <div class="product_link_area">
                                            <ul>
                                                <li><a href="cart.php?proid=3&qty=1"
                                                        class="add_cart_btn">Add To Cart</a></li>
                                                <li><a href="checkout.php?proid=3&qty=1"
                                                        class="buy_now_btn">Buy Now</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="add-to-link">
                                            <ul>
                                                        ...
                                                        href="cart.php?proid=3&qty=1">ADD
                                                        TO CART </a></li>
                                                                                                                                                <li>
                                                    <a href="wishlist.php?proid=3&qty=1"><i
                                                            class="ion-android-favorite-outline"></i></a>
                                                </li>
                                                <!--<li>
                                    ...
                                    <article class="list-product">
                                        <div class="img-block">
                                            ...
                                            <a href="product.php?id=2" class="thumbnail">
                                                <img class="first-img"
                                                    src="wap/upload/products/147409unlock.avif"
                                                    alt="" />
                                                <!--<img class="second-img" src="assets/images/product-image/organic/product-16.jpg" alt="" />-->
                                            </a>
                                            <!--<div class="quick-view">
                                        ...
                                        <div class="product_link_area">
                                            <ul>
                                                <li><a href="cart.php?proid=2&qty=1"
                                                        class="add_cart_btn">Add To Cart</a></li>
                                                <li><a href="checkout.php?proid=2&qty=1"
                                                        class="buy_now_btn">Buy Now</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="add-to-link">
                                            <ul>
                                                                                                <li class="cart"><a class="cart-btn"
                                                        href="cart.php?proid=2&qty=1">ADD
                                                        TO CART </a></li>
                                                                                                                                                <li>
                                                    <a href="wishlist.php?proid=2&qty=1"><i
                                                            class="ion-android-favorite-outline"></i></a>
                                                </li>
                                                <!--<li>
                                                <a href="compare.html"><i class="ion-ios-shuffle-strong"></i></a>
                                    ...
                                    <article class="list-product">
                                        <div class="img-block">
                                            ...
                                            <a href="product.php?id=1" class="thumbnail">
                                                <img class="first-img"
                                                    src="wap/upload/products/683360Screenshot 2025-07-05 045445.png"
                                                    alt="" />
                                                <!--<img class="second-img" src="assets/images/product-image/organic/product-16.jpg" alt="" />-->
                                            </a>
                                            <!--<div class="quick-view">
                                        ...
                                        <div class="product_link_area">
                                            <ul>
                                                <li><a href="cart.php?proid=1&qty=1"
                                                        class="add_cart_btn">Add To Cart</a></li>
                                                <li><a href="checkout.php?proid=1&qty=1"
                                                        class="buy_now_btn">Buy Now</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="add-to-link">
                                            <ul>
                                                                                                <li class="cart"><a class="cart-btn"
                                                        href="cart.php?proid=1&qty=1">ADD
                                                        TO CART </a></li>
                                                                                                                                                <li>
                                                    <a href="wishlist.php?proid=1&qty=1"><i
                                                            class="ion-android-favorite-outline"></i></a>
                                                </li>
                                                <!--<li>
                                                <a href="compare.html"><i class="ion-ios-shuffle-strong"></i></a>
        ...
        <section class="recent-add-area" style="display:none;">
            <div class="container">
                ...
                <div class="recent-product-slider owl-carousel owl-nav-style">
                        ...
                        <div class="img-block">
                            <a href="product.php?id=3" class="thumbnail">
                                <img class="first-img" src="upload/products/714161file.png"
                                    alt="" />
                        ...
                        <ul class="product-flag">
                            ...
                            <a class="inner-link" href="#"><span>
                                    Mothobord                                </span></a>
                            <h2><a href="product.php?id=3" class="product-link">
                                    OPPO                                </a></h2>
                            <div class="rating-product">
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                        ...
                        <div class="add-to-link">
                            <ul>
                                                                <li class="cart"><a class="cart-btn"
                                        href="cart.php?proid=3&qty=1">ADD TO CART </a>
                                </li>
                                                                                                <li>
                                    <a href="wishlist.php?proid=3&qty=1"><i
                                            class="ion-android-favorite-outline"></i></a>
        ...
        <section class="home_about_content_section" style="display:none;">
            <div class="container">
                <div class="home_about_content_sectioninner">
                    ...
                    <h4>About Us</h4>
                    <p>Ethniczoom is a premium platform for Online dress shopping. At Ethniczoom, we are dedicated to
                        offer stylish, trendy and reliable products. We offer shopping that is light on your pockets,
                        the Shopping that offers your favourite brands and more, the Shopping that is simpler, easier,
                        faster and matches your needs.</br></br>
                        Ethniczoom offers a wide variety of products ranging from Ladies Kurtis, Tops, Fashion
                        Jewellery, branded Lingerie, Handbags and Nightwear to Women's Underwear & Vests and Sexual Well
                        Being. Providing a huge variety of products ranging from personal care to fashion clothing and
                        fashion jewellery, Cilory makes online shopping a memorable experience for everybody.</p></br>
                    <h4>Dedicated to Brings Smiles</h4>
                    <p>At Ethniczoom, we are dedicated to provide the best of online shopping experience to our
                        customers. We have a dedicated team to handle customer queries both on phone as well as on chat.
                        Our mission is to bring smiles to the face of every individual who shops at Ethniczoom. You
                        choose a product and we deliver it right at your address across India within 3-5 business days.
                        For those who are not comfortable using paying online, we offer a Cash-On-Deliver option while
                        for those having second thoughts after purchase, we have in place a 7-day return option as well.
                    </p></br>
                    <h4>Ethniczoom - the 24x7 Online Fashion and Lifestyle Shop</h4>
                    <p>At Ethniczoom, we have almost everything to light up your fashion buds. From extensive range of
                        men's shirts to exotic dresses for women to stylish lingerie & accessories for everyone, we
                        offer diversity of choices under one umbrella. We value our customers and their feedbacks and
                        continuously work towards improving your shopping experience. Do write to us at cs [at]
                        ethniczoom.com or call us at +91 70482 91002 for any queries/feedbacks/suggestions or for any
                        help in placing an order with us.</p>
                </div>
            </div>
        </section>
