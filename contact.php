...
<title>Contact Us - Getwayrom</title>
<!-- Favicon -->
    ...
    <div class="search_container">
      ...
      setTimeout(() => {
          try {
            ...
            <div class="contact-area mtb-60px">
                <div class="container">
                    <!--<div class="contact-map mb-10">
                       <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Vasta%20Devadi%20Road,%20Katargam,%20Surat%20-%20395004&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://embedgooglemap.net/139/"></a></div><style>.mapouter{position:relative;text-align:right;height:500px;width:100%;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:100%;}</style></div>
                    </div>-->
                    <div class="custom-row-2" style="align-items: center;justify-content: center;">
                        <!--<div class="col-lg-4 col-md-5">
                            <div class="contact-info-wrap">
                                ...
                                <div class="single-contact-info">
                                    ...
                                    <div class="contact-info-dec">
                                        <p><a href="mailto:sales.ethniczoom@gmail.com">sales.ethniczoom@gmail.com</a></p>
                                ...
                                <div class="single-contact-info">
                                    ...
                                    <div class="contact-info-dec">
                                        <p>Gangeshwer anad Compund, Vasta Devadi Road, Katargam, Surat - 395004</p>
                       ...
                       <!-- <div class="col-lg-8 col-md-7">
                            <div class="contact-form">
                                <div class="contact-title mb-30">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <input name="name" placeholder="Name*" type="text" style="background-color:#FFFFFF;" required />
                                        </div>
                                        <div class="col-lg-6">
                                            <input name="email" placeholder="Email*" type="email" style="background-color:#FFFFFF;" required />
                                        </div>
                                        <div class="col-lg-6">
                                            <input name="phone" placeholder="Phone*" type="text" style="background-color:#FFFFFF;" required/>
                                        </div>
                                        <div class="col-lg-6">
                                            <input name="subject" placeholder="Subject" type="text" style="background-color:#FFFFFF;" />
                                        </div>
                                        <div class="col-lg-12">
                                            <textarea name="message" placeholder="Your Message*" style="background-color:#FFFFFF; height:130px;" required></textarea>
			...
			<section class="contact_field_section">
			<div class="container">
			<div class="contact_field_sectioninner">
			<div class="row">
			
			<div class="col-xs-4 col-lg-4 col-md-4 col-sm-6 col-12">
			<div class="contact_field_blk">
				<div class="inner-box">
					<div class="icon-box"><i class="far fa-map"></i></div>
					<h3>Office Address</h3>
					<p>Mumbai-Goa Road, Amroy Complex, 2nd Floor, House No. 201, Near Railway Station, At. Post. Mangaon, Dist Raigad 402104</p>
				</div>
			</div>
			</div>
			...
			<div class="contact_field_blk">
				<div class="inner-box">
					...
					<p>Support  <a href="tel:+919420630774">(+91) 9420630774</a></p>
			...
			<div class="contact_field_blk">
				<div class="inner-box">
					...
					<h3>Email Information</h3>
					    <p><a href="mailto:info@getwayrom.com">info@getwayrom.com</a></p>
				</div>
			</div>
			</div>
			</div>
			...
			<div class="contact-map mb-10" style="margin-bottom:0px;">
                   <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=International+Trade+Center+Building,+Majura+Gate+Rd,+Kailash+Nagar,+Majura+Gate,+Surat,+Gujarat+395001&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://embedgooglemap.net/139/"></a></div><style>.mapouter{position:relative;text-align:right;height:500px;width:100%;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:100%;}</style></div>
                </div>
			</section>-->
