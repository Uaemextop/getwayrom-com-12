...
<title>Share Link | Getwayrom</title>
<!-- Favicon -->
...
.form-control:focus {
    outline: none;
    border-color: #a0b93a;
    box-shadow: 0 0 0 3px rgba(160, 185, 58, 0.1);
}

.btn-submit {
    width: 100%;
    padding: 14px 20px;
    background: linear-gradient(135deg, #a0b93a 0%, #8fa030 100%);
    color: #ffffff;
    border: none;
    border-radius: 8px;
    font-size: 1.1rem;
...
.btn-submit:hover {
    background: linear-gradient(135deg, #8fa030 0%, #7a8a28 100%);
    transform: translateY(-2px);
    box-shadow: 0 5px 15px rgba(160, 185, 58, 0.3);
}
...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-content">
                        <h1 class="breadcrumb-hrading">Share Link</h1>
    ...
    <!-- Share Link Form Area start -->
    <div class="share-link-container">
        <div class="container">
            <div class="share-link-form-wrapper">
                <div class="section-title">
                    <h2>Share Your Link</h2>
                    <p>Submit your link with your name and contact number. We'll review and get back to you.</p>
                </div>
                
                                
                                
                <form method="POST" action="" id="shareLinkForm">
                    <div class="form-group">
                    ...
                    <button type="submit" name="submit_share_link" class="btn-submit">
                        Submit Link
                    </button>
                </form>
            </div>
