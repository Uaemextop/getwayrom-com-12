...
<head>
  ...
  <title>Terms and Condition | Getwayrom</title>

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800&amp;display=swap" rel="stylesheet" />

  <!-- Existing site CSS (minified styles you already use) -->
  <link rel="stylesheet" href="assets/css/vendor/plugins.min.css">
  <link rel="stylesheet" href="assets/css/style.min.css">
  <link rel="stylesheet" href="assets/css/responsive.min.css">

  <!-- Page-specific styling to match the screenshot -->
  <style>
    :root{
      --page-bg: #f5f6f7;
      --card-bg: #ffffff;
    ...
    html,body{height:100%;margin:0;font-family: 'Open Sans', Arial, Helvetica, sans-serif;background:var(--page-bg);color:var(--text);-webkit-font-smoothing:antialiased;}
    /* breadcrumb / hero */
    .breadcrumb-area{
    ...
    .breadcrumb-links{ margin-top:8px; list-style:none; padding:0; font-size:13px; color:var(--muted); }
    .breadcrumb-links li{ display:inline-block; color:var(--muted); }
    .breadcrumb-links li a{ color:var(--muted); text-decoration:none; }
    /* main layout */
    .content-area{
    ...
    /* left column which holds the terms (narrow like screenshot) */
    .terms-column{
    }
    .terms-card{
      border-radius:6px;
    ...
    /* right column intentionally left blank (creates big right whitespace) */
    .terms-side{
      flex:1;
      min-width: 0;
    }
    ...
    /* subtle top-left small heading used in screenshot */
    .section-small{
      color:var(--muted);
      font-size:13px;
      margin-bottom:8px;
    ...
    @media (max-width:1000px){
      ...
      .terms-column{ width:100%; }
      .terms-side{ display:none; }
...
<body>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="breadcrumb-content">
              <h1 class="breadcrumb-hrading">Terms and Conditions</h1>
    ...
    <!-- Main content like screenshot: narrow white card on left, whitespace on right -->
    <main class="content-area">
      <div class="terms-column">
        <div class="terms-card">

          <div class="section-small">Terms of Service</div>
          <h1>Terms of Service</h1>

          <h2>Introduction</h2>
          <p>Welcome to getwayrom.com. These are the terms and conditions governing your access to and use of the website getwayrom.com and its related sub-domains, sites, services and tools (the "Site"). By accepting these terms and conditions (including the linked information herein), and by using the Site, you represent that you agree to comply with these terms and conditions with getwayrom.com ("Getwayrom", "us" or "getwayrom.com") in relation to your use of the Site (the "User Agreement"). This User Agreement is effective upon acceptance. If you do not agree to be bound by this User Agreement please do not access, register with or use this Site.</p>

          <p>Before you may become or continue as a member of the Site, you must read, agree with and accept this User Agreement and getwayrom.com's Privacy Policy (the "Privacy Policy"). You should read this User Agreement and the Privacy Policy and access and read all further linked information referred to in this User Agreement, as such information contains further terms and conditions that apply to you as a user of getwayrom.com. Such linked information including but not limited to the Privacy Policy is hereby incorporated by reference into this User Agreement.</p>
