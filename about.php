...
<title>About Us | Getwayrom</title>
<!-- Favicon -->
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 ml-auto mr-auto">
                            <div class="login-register-wrapper">
                                ...
                                <div>
                                    <div style="text-align:left; padding:0 0 50px 0;">
                                    <h3>This website is owned & managed by <b>KGN Mobile Service Center</b></h3>.</p>
                                    <p>Getwayrom team has initiated a huge portal of mobile firmwares for the entire world, here you may find almost all the "stock firmwares" available.</p></br>
                                    <p>And we are just starting now and growing very fast on a day-to-day basis This is the only One platform where we provide firmwares at a very attractive price, we do not intend to harm or be an excuse for loss for any company, organisation or business. That is not our intention.</p></br>
                                    <p><b>A note to the visitors of Getwayrom:</b><br />Every day about 2,000 to 5,000 visits are scored by our website where a maximum of<br />the visitors are from India, Indonesia, Bangladesh, Nepal, and others.</p></br>
                                    <p>Almost all the firmware are available and we also welcome firmware requests and we positively believe we can provide the requested files We will be constantly monitoring things, making fixes as issues are discovered, and will be completing the redesign for some sections that are left out (like the forum), in addition to fine-tuning everything over the coming days to make sure our readers continue to have the greatest experience browsing through Givemerom.</p></br>
                                    <p><strong>Our Services Include:</strong><br />1. Firmware Provide<br />2. Firmware Solution<br />3. Flahing Solutions<br /><br />We are working hard to facilitate and deliver relevant, practical support to small businesses and foster the development of policy conducive to the growth of a thriving sector.</p></br>
                                    <p>Client satisfaction is on the highest priority of our business. Every single task of our company is devoted to client&rsquo;s satisfaction. We care about ease of client during project execution process. Flexibility plays vital role in successful project execution. We have adaptability to remain committed to the quality and output considering your needs.</p>
                                    </br>
                                </div>
