...
<head>
    ...
    <title>Subscription Plans - Getwayrom</title>
    
    <!-- Meta Tags -->
    <meta name="description" content="Choose the perfect subscription plan for your firmware download needs. Affordable plans with instant activation.">
    ...
    <style>
        :root {
            --primary-color: #a0b93a;
            --primary-light: #b8d145;
            --primary-dark: #8ba332;
            --secondary-color: #00712D;
            --secondary-light: #0d8540;
            --accent-color: #ff4444;
            --accent-light: #ff6b6b;
            --text-primary: #1a202c;
        ...
        * {
        ...
        .plan-card::before {
            ...
            background: linear-gradient(90deg, 
                transparent 0%, 
                rgba(160, 185, 58, 0.05) 30%, 
                rgba(160, 185, 58, 0.1) 50%, 
                rgba(160, 185, 58, 0.05) 70%, 
                transparent 100%);
        ...
        .plan-price {
            ...
            color: var(--primary-color);
            margin-bottom: 6px;
            text-shadow: 0 2px 4px rgba(160, 185, 58, 0.2);
            letter-spacing: -0.02em;
            line-height: 1;
        }
        ...
        .feature-highlight {
            background: linear-gradient(135deg, rgba(160, 185, 58, 0.08), rgba(0, 113, 45, 0.05));
            padding: 16px;
            border-radius: var(--radius-sm);
            margin-bottom: 20px;
            border: 2px solid rgba(160, 185, 58, 0.2);
            position: relative;
            overflow: hidden;
        }
        ...
        .btn-buy {
            ...
            position: relative;
            overflow: hidden;
            box-shadow: 0 4px 12px rgba(160, 185, 58, 0.3);
            margin-top: auto;
            z-index: 2;
            transform: translateZ(0);
            backface-visibility: hidden;
        ...
        .btn-buy:hover {
            ...
            color: white;
            box-shadow: 0 8px 20px rgba(160, 185, 58, 0.4);
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Select the perfect subscription for your firmware download needs</p>
        </div>
        ...
        <!-- User Status Info -->
            ...
            <div class="guest-info">
                ...
                <h4>Quick Access to Premium Plans</h4>
                <p>Login to your account for instant purchase, or create a new account to get started.</p>
                <div class="btn-group">
                    <a href="login.php" class="btn btn-login">
                        <i class="bi bi-box-arrow-in-right me-2"></i>Login
                    </a>
                    <a href="login.php?tab=register" class="btn btn-signup">
        ...
        <!-- Info for guests with URL message -->
        ...
        <div class="plans-grid">
                    ...
                    <div class="plan-card empty-state">
                        ...
                        <p>We're currently updating our subscription plans. Please check back later.</p>
                                                    <a href="index.php" class="btn-buy">Return to Home</a>
                                            </div>
                </div>
                    </div>
    </div>
...
<link rel="preload" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    ...
    <script>
    // Function to handle payment redirect for logged-in users
    function proceedToPayment(planId) {
        ...
        const confirmed = confirm(
            'Continue to secure payment checkout?\n\n' +
        ...
        // Redirect to the current page with buy parameter
        try {
            window.location.href = `?buy=${planId}&t=${Date.now()}`;
        } catch (error) {
    ...
    // Function to handle login redirect for guests
    function redirectToLogin(planId) {
        const confirmed = confirm(
            'You need to login to purchase this plan.\n\n' +
            '✓ Quick login process\n' +
        ...
        if (confirmed) {
            window.location.href = `login.php?redirect=Payment&plan_id=${planId}&message=${encodeURIComponent('Please login to purchase this plan')}`;
        }
    }
